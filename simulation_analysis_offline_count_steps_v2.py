...
if __name__ == '__main__':
  ...
  name_config = file_prefix + '.' + str(first_index) + '.' + str(second_index) + '.' + str(N_samples) + '.' + structure_prefix + str(number_simulation) + '.' + str(first_index) + '.' + str(second_index) + '.' + str(N_samples) + '.config'
  N = sa.read_particle_number(name_config)

  # Copy input file
  name_input = file_prefix + '.' + str(first_index) + rerun_n + str(N_samples - 1) + '.inputfile'
  inputfile_name = inputfile_prefix + '.' + str(first_index) + rerun_n + str(N_samples) 
